...
//    NSArray *indicators = [NSJSONSerialization JSONObjectWithData:content
//                                                        options:0
//                                                          error:nil];
//    self.indicatorList = indicators;
////    NSArray *specificIndicator = [NSJSONSerialization JSONObjectWithData:indicators
////                                                                 options:0
////                                                                   error:nil];
////    NSArray *specificIndicatorList = specificIndicator;
//    
//}
